	  ...
	  _createClass(Gallery, [{
	    ...
	    value: function renderPhotos() {
	      ...
	      if (this.state.photos) {
	        ...
	        var photoGallery = React.createElement(
	          'div',
	          ...
	          React.createElement(
	            ...
	            React.createElement(
	              'a',
	              { href: photos[0].urls.full },
	              React.createElement('img', { className: 'img-fluid', src: photos[0].urls.regular })
	            ),
	            React.createElement(
	              'a',
	              { href: photos[3].urls.full },
	              React.createElement('img', { className: 'img-fluid', src: photos[3].urls.regular })
	            ),
	            React.createElement(
	              'a',
	              { href: photos[6].urls.full },
	              React.createElement('img', { className: 'img-fluid', src: photos[6].urls.regular })
	            ),
	            React.createElement(
	              'a',
	              { href: photos[9].urls.full },
	              React.createElement('img', { className: 'img-fluid', src: photos[9].urls.regular })
	            )
	          ),
	          React.createElement(
	            'div',
	            ...
	            React.createElement(
	              'a',
	              { href: photos[1].urls.full },
	              React.createElement('img', { className: 'img-fluid', src: photos[1].urls.regular })
	            ),
	            React.createElement(
	              'a',
	              { href: photos[4].urls.full },
	              React.createElement('img', { className: 'img-fluid', src: photos[4].urls.regular })
	            ),
	            React.createElement(
	              'a',
	              { href: photos[7].urls.full },
	              React.createElement('img', { className: 'img-fluid', src: photos[7].urls.regular })
	            ),
	            React.createElement(
	              'a',
	              { href: photos[10].urls.full },
	              React.createElement('img', { className: 'img-fluid', src: photos[10].urls.regular })
	            )
	          ),
	          React.createElement(
	            'div',
	            ...
	            React.createElement(
	              'a',
	              { href: photos[2].urls.full },
	              React.createElement('img', { className: 'img-fluid', src: photos[2].urls.regular })
	            ),
	            React.createElement(
	              'a',
	              { href: photos[5].urls.full },
	              React.createElement('img', { className: 'img-fluid', src: photos[5].urls.regular })
	            ),
	            React.createElement(
	              'a',
	              { href: photos[8].urls.full },
	              React.createElement('img', { className: 'img-fluid', src: photos[8].urls.regular })
	            ),
	            React.createElement(
	              'a',
	              { href: photos[11].urls.full },
	              React.createElement('img', { className: 'img-fluid', src: photos[11].urls.regular })
	            )
	          )
	        );
	        ...
	        React.createElement(
	          ...
	          React.createElement(
	            ...
	            React.createElement(
	              ...
	              React.createElement('input', { className: 'form-control mr-sm-2', name: 'query', value: this.state.query, placeholder: 'Search', onChange: function onChange(e) {
	                  return _this3.handleInputChange(e);
	                } }),
	              React.createElement(
	                'button',
	                { type: 'submit', className: 'my-sm-0 btn btn-primary', onClick: function onClick(e) {
